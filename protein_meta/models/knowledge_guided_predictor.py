...
from protein_meta.npt.proteinnpt.utils.esm.modules import (  # ESM1bLayerNorm,
...
from protein_meta.models.losses import get_loss
...
class ProteinNPTMetaSurrogate(BaseMetaModel, nn.Module):
